import { C as escape_html, i as ensure_array_like, t as attr_class, x as attr } from "../../../chunks/server.js";
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(` <button class="primary"${attr("disabled", (noteQuery.trim(), true), true)}>${escape_html("Search")}</button> `);
		$$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]--></div> `);
		$$renderer.push("<!--[-1-->");
