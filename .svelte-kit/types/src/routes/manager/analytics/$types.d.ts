...
type RouteParams = {  };
type RouteId = '/manager/analytics';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/manager/analytics/+page.server.js').load>>>>>>;
