...
export function GET({ url }) {
  ...
  // CSV
  const headers = [
    'match_number', 'team_number', 'team_name', 'scouter_name',
    'auto_leave', 'auto_classified', 'auto_overflow',
    'teleop_classified', 'teleop_overflow', 'opened_gate',
    'endgame_base', 'defense_rating', 'driver_skill', 'reliability',
    'notes', 'created_at', 'score_red', 'score_blue'
  ];
